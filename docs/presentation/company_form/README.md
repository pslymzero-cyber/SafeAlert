...
| 6 | 2. 기대효과 — 2) 비용 비교 (I-PAS 대비) |
| 7 | 3. 장단점 — 1) I-PAS 와 비교  2) 앱의 단점  3) 대응 (PDA 이식) |
| 8 | 4. 앞으로 수정계획 — Phase 1~5 |
| 9 | 5. 테스트 중간 결과 — WF11 · WF21 · WF25 (**미기입**) |
| 10 | 부록 A — 비용 산출 근거 |
| 11 | 부록 B — 사용자 피드백 |
| 12 | 부록 C — 시연 (화면 + 영상) |
| 13 | 부록 D — Andon |
...
| 기대효과 — I-PAS 유사 기능으로 사각지대 사전 예방 / 비용비교 | 5 · 6장. 사내 폼 관례대로 같은 절 번호를 두 장에 나눠 `1)` `2)` 로 |
| 장단점 — I-PAS 비교 / 앱의 단점 / Phase2 PDA 이식 | 7장 한 장에 세 블록 |
| 앞으로 수정계획 — Phase 1~5 | 8장. Phase 2 에 `+ PDA 이식` 을 붙였다 |
| 테스트중간결과 — 센터 11 · 21 · 25 서베이 | 9장 **틀만**. 서베이 미회수 상태라 결과란은 `—` |
...
- 7장 `앱의 단점` 2번으로 올렸다 — "업무 단말이 아니라 개인 폰에 깔려 있어 지속 가능한 상태가 아니다"
- 대응은 매니저 판단대로 **Phase 2 PDA 이식**. 8장 로드맵과 3장 요청 상자에도 같이 넣었다
