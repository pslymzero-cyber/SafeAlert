...
| 6 | 3. 장단점 — Tradeoffs 4행 / 남는 한계 |
| 7 | 4. 사용자 피드백 — 오더십 리뷰 3차 반영 / 현장 요구 |
| 8 | 5. 시연 — 동작·설정 화면 + 재생되는 시연 영상 |
| 9 | 6. 진행 단계 — Phase 1~5 표 + 이 순서인 이유 |
| 10 | 7. Andon — 현장 · 배포 중 중단 기준과 조치 |
| 11 | **8. 요청 사항** — 무엇을 / 왜 필요한가 / 없으면 |
