...
CONC = [
    ...
    (3.63, "해결", "이미 나눠준 스마트폰끼리 서로를 감지하게 만들었습니다",
     [[("앱만 깔면 15m 에서 경고, 8m 에서 위험 경보가 소리 · 진동 · 화면으로 울립니다. "
        "장비를 사거나 센터에 무엇을 설치할 필요가 없습니다.", {})]]),
    (5.19, "증거", "만들겠다는 계획이 아니라, 이미 쓰고 있는 앱입니다",
     [[("3개월 동안 70번 넘게 고쳐가며 ", {}),
        ("WF11 · WF21 · WF25 세 개 센터에서 실제로 돌고 있습니다",
         {"bold": True, "color": C.TEAL}),
        (".  같은 기능을 장비로 갖추면 센터당 331만원이 들지만(타 조직 도입 사례 기준), "
         "이 앱은 추가 비용이 없습니다.", {})]]),
]
...
C.fill(C.body_of(s, "Short term"),
       [[("업무용 스마트폰에 앱을 깔아, 폰끼리 서로를 감지하게 한다",
        ...
        [("지금 v1.1.70 이 WF11 · WF21 · WF25 에서 돌고 있다.",
...
PLAN = [
    ...
    ("보안 검토 — 앱 보호 미적용 · 경보 기록 암호화 안 됨", "보안", "확산 전", "협조"),
